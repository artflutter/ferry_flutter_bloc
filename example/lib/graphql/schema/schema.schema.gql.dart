...
class Gfake__Types extends EnumClass {
  ...
  static const Gfake__Types hackerAbbr = _$gfakeTypeshackerAbbr;
...
class Gfake__imageCategory extends EnumClass {
  const Gfake__imageCategory._(String name) : super(name);

  static const Gfake__imageCategory abstract = _$gfakeImageCategoryabstract;

  static const Gfake__imageCategory animals = _$gfakeImageCategoryanimals;

  static const Gfake__imageCategory business = _$gfakeImageCategorybusiness;

  static const Gfake__imageCategory cats = _$gfakeImageCategorycats;

  static const Gfake__imageCategory city = _$gfakeImageCategorycity;

  static const Gfake__imageCategory fashion = _$gfakeImageCategoryfashion;

  static const Gfake__imageCategory food = _$gfakeImageCategoryfood;

  static const Gfake__imageCategory nature = _$gfakeImageCategorynature;

  static const Gfake__imageCategory nightlife = _$gfakeImageCategorynightlife;

  static const Gfake__imageCategory people = _$gfakeImageCategorypeople;

  static const Gfake__imageCategory sports = _$gfakeImageCategorysports;

  static const Gfake__imageCategory technics = _$gfakeImageCategorytechnics;

  static const Gfake__imageCategory transport = _$gfakeImageCategorytransport;

  static Serializer<Gfake__imageCategory> get serializer =>
      _$gfakeImageCategorySerializer;
  static BuiltSet<Gfake__imageCategory> get values =>
      _$gfakeImageCategoryValues;
  static Gfake__imageCategory valueOf(String name) =>
      _$gfakeImageCategoryValueOf(name);
}
...
abstract class Gfake__color
  ...
  Map<String, dynamic> toJson() =>
      _i1.serializers.serializeWith(Gfake__color.serializer, this);
  static Gfake__color fromJson(Map<String, dynamic> json) =>
      _i1.serializers.deserializeWith(Gfake__color.serializer, json);
}
...
abstract class Gfake__options
  ...
  @nullable
  Gfake__imageCategory get imageCategory;
  @nullable
  int get imageHeight;
  @nullable
  int get imageWidth;
  ...
  Map<String, dynamic> toJson() =>
      _i1.serializers.serializeWith(Gfake__options.serializer, this);
  static Gfake__options fromJson(Map<String, dynamic> json) =>
      _i1.serializers.deserializeWith(Gfake__options.serializer, json);
}
...
abstract class Gexamples__JSON
  ...
  static Serializer<Gexamples__JSON> get serializer =>
      _i2.DefaultScalarSerializer<Gexamples__JSON>(
