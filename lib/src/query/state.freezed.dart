...
// ignore: unused_element
  QueryStateRefetch<T> refetch<T>(
      {T data, OperationResponse<dynamic, dynamic> result}) {
...
// ignore: unused_element
  QueryStateFetchMore<T> fetchMore<T>(
      {@required T data, OperationResponse<dynamic, dynamic> result}) {
...
mixin _$QueryState<T> {
  ...
  Result when<Result extends Object>({
    ...
    @required
        Result refetch(T data, OperationResponse<dynamic, dynamic> result),
    @required
        Result fetchMore(T data, OperationResponse<dynamic, dynamic> result),
  });
  @optionalTypeArgs
...
abstract class QueryStateRefetch<T> implements QueryState<T> {
  const factory QueryStateRefetch(
      {T data,
      OperationResponse<dynamic, dynamic> result}) = _$QueryStateRefetch<T>;
...
abstract class QueryStateFetchMore<T> implements QueryState<T> {
  const factory QueryStateFetchMore(
      {@required T data,
      OperationResponse<dynamic, dynamic> result}) = _$QueryStateFetchMore<T>;
